# This file is pull fromed LAFAND-MT repo. This is like a backup but I bet it should work directly here
# Same with the [run_translation_2.py], it was a direct copy from HuggingFace
# The translation file, is the file we use to train, evaluate and test the models
...
def combine_texts_lafand(input_path, output_path, direction='en-sw', n_sent=50000):
    ...
    df_train = pd.read_csv(input_path + 'yoruba_bible_data/processed_yoruba_bible.tsv', sep='\t') #[For CSV, use sep=',']
    ...
    export_json_files(output_dir, 'bible_train.json', df_train_sctg, direction=direction)
